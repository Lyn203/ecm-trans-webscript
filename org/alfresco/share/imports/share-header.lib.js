            ...
            widgets: [
               {   
                  ...
                  config: {
                     widgets: [
                        {
                           id: "HEADER_REPORTS_SUB11",
                           name: "alfresco/header/AlfMenuItem",
                           config:
                           {
                              id: "HEADER_REPORTS_SUB11",
                              label: "Thống kê số hóa",
                              targetUrl: "/hdp/ws/simple-page",
   ...
   var headerModel = [{
      ...
      config: {
         ...
         widgets: [
		  ...
		  placeholder: "Tìm tệp, thư mục, users",
                  sitePage: ""
               }
            }
         ]
